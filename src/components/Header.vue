                ...
                <nav class="col-md-6 a mt-5 d-flex align-items-start justify-content-end">
                    ...
                    >
                        ...
                        <div id="carrito" class="bg-white p-3">
                            ...
                            <div  v-else>
                              <table class="w-100 table">
                                <thead>
                                  ...
                                  <tbody >
                                    <tr v-for="carrito in carrito">
                                      <td>
                                        <img class="img-fluid" :src="'/img/' + carrito.imagen + '.jpg'" :alt="'imagen carrito' + carrito.nombre">
                                      </td>
                                      <td>{{carrito.nombre}}</td>
                                        <td class="fw-bold">
                                              ...
                                              <td class="flex align-items-start gap-4">
                                                ...
                                                type="button"
                                                class="btn btn-dark"
                                                @click="emit('decrementarCantidad',carrito.id)"
                                                >
                                                -
                                              </button>
                                              {{ carrito.cantidad }}
                                              ...
                                              type="button"
                                              class="btn btn-dark"
                                              @click="$emit('incrementarCantidad',carrito.id)"
                                              >
                                              +
                                            </button>
                                          </td>
                                          <td>
                                            ...
                                            class="btn btn-danger"
                                                type="button"
                                                @click="$emit('eliminarProducto',carrito.id)"
                                            >
                                                X
                                              </button>
                                        </td>
                            ...
                            <button class="btn btn-dark w-100 mt-3 p-2" @click="$emit('vaciarCarrito',carrito.id)">Vaciar Carrito</button>
                          </div>
                        </div>
                    </div>
                </nav>
